# -*- coding: utf-8 -*-
"""
Created on Mon Jun  5 12:36:46 2023
...
if __name__ == '__main__':
    # relative file paths
    rel_path_CEMS = "../../Data/Simple Dispatch Outputs/2023-04-18 act ba regions/Actual CEMS" # folder with observed emissions
    ...
    fn_ends = [['SOCO', 'GA', 'AL', 'FL', 'MS'], # ATL regional
               ['CT', 'NY', 'PA', 'NJ', 'DE', 'MD', 'VA', 'WV', 'OH', 'KY', 'MI', 'IL', 'NC', 'IN']] # NYC regional
    # ML file names
